...
in July. It follows Domain-Driven Design principles with proper type hints and
    ...
    def _render_email_content(
        ...
        full_context = {
            **template_context,
            ...
            "application_title": branding.application_title if branding.enabled else "July",
        }
...
def create_default_email_config() -> EmailI18nConfig:
    ...
    templates: dict[EmailType, dict[EmailLanguage, EmailTemplate]] = {
        ...
        EmailType.ACCOUNT_DELETION_VERIFICATION: {
            EmailLanguage.EN_US: EmailTemplate(
                subject="July Account Deletion and Verification",
