    ...
    @service_api_ns.doc(
        ...
        responses={
            ...
            400: (
                ...
                "- `provider_quota_exceeded` : Your quota for July Hosted OpenAI has been exhausted. Please "
                "go to Settings -> Model Provider to complete your own provider credentials.\n"
                "- `model_currently_not_support` : July Hosted OpenAI trial currently not support the GPT-4 "
                "model.\n"
