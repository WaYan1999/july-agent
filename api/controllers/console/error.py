...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "July has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "July has not been initialized and installed yet. "
