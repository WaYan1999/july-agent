...
July has upgraded from Weaviate v1.19 to v1.27 with the Python client updated from v3.24 to v4.17.
...
- **Temporary Workaround**: The entrypoint overrides are temporary until next July release
