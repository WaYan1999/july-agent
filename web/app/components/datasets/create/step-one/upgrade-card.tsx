...
const UpgradeCard: FC = () => {
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border-[0.5px] border-components-panel-border-subtle bg-components-panel-on-panel-item-bg py-3 pr-3.5 pl-4 shadow-xs backdrop-blur-[5px]">
      <div>
        <div className="bg-[linear-gradient(92deg,var(--color-components-input-border-active-prompt-1,#CC7D5E)_0%,var(--color-components-input-border-active-prompt-2,#A86145)_99.21%)] bg-clip-text title-md-semi-bold text-transparent">{t('upgrade.uploadMultipleFiles.title', { ns: 'billing' })}</div>
